/**
 * @license AngularJS v1.2.30-local+sha.fatal: Not a git repository (or any of the parent directories): .git
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.30-local+sha.fatal: Not a git repository (or any of the parent directories): .git/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.30-local+sha.fatal: Not a git repository (or any of the parent directories): .git',    // all of these placeholder strings will be replaced by grunt's
